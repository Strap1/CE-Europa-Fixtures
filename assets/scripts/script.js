...
let json = fetch('https://opensheet.vercel.app/1r4AR5yDnQ9LLlVovYv-vaYc_Ik8UfGdPx5DbWOEVhtI/Dades')
  .then(res => res.json())
  .then(data => {
    data.forEach(row => {
...
// Show latest league position for Europa
function showStandings() {

  let json = fetch('https://opensheet.vercel.app/1r4AR5yDnQ9LLlVovYv-vaYc_Ik8UfGdPx5DbWOEVhtI/Season')
    .then(res => res.json())
    .then(data => {
      data.forEach(row => {
